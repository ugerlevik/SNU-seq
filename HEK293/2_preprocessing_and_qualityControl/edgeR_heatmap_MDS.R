...
colnames(data) <- gsub("_trimmed_Aligned.sortedByCoord.out.bam", "", colnames(data))
colnames(data) <- gsub("X.MellorLab.SNUseqProject.1_Umut.2_mapped_bamFiles.", "", colnames(data))
...
rownames(MDSxy) <- rownames(MDSdata$distance.matrix.squared)
