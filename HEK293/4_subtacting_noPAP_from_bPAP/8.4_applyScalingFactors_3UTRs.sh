...
# Directory paths
input_bedgraph_folder=$prefix/1_Umut/6.1_merged_bedgraph_strandSpecific

output_bedgraph_folder=$prefix/1_Umut/10.2_spikeNorm_3UTRnormalised_bedgraph
output_bigwig_folder=$prefix/1_Umut/10.3_spikeNorm_3UTRnormalised_bigwig
output_bedgraph_bothStrand_folder=$prefix/1_Umut/10.4_spikeNorm_3UTRnormalised_bedgraph_bothStrand
output_bigwig_bothStrand_folder=$prefix/1_Umut/10.5_spikeNorm_3UTRnormalised_bigwig_bothStrand
...
scaling_factors_file=$prefix/1_Umut/10.1_countsRegions_fromBedgraph/DESeq2_scalingFactors_3UTRs.txt
...
for bedgraph_file in "$input_bedgraph_folder"/*.bedgraph; do
    bedgraph_basename=$(basename "$bedgraph_file" _merged.bedgraph)
    ...
    scaled_bedgraph_file="$output_bedgraph_folder/${bedgraph_basename}_3UTRnormalised.bedgraph"
    scaled_bigwig_file="$output_bigwig_folder/${bedgraph_basename}_3UTRnormalised.bw"
...
for bedgraph_file_fwd in "$output_bedgraph_folder"/*_fwd_3UTRnormalised.bedgraph; do
    
    base_name=$(basename "$bedgraph_file_fwd" "_fwd_3UTRnormalised.bedgraph")
    bedgraph_file_rev="$output_bedgraph_folder/${base_name}_rev_3UTRnormalised.bedgraph"
    ...
    merged_bedgraph_file="$output_bedgraph_bothStrand_folder/${base_name}_bothStrand_3UTRnormalised.bedgraph"
    merged_bigwig_file="$output_bigwig_bothStrand_folder/${base_name}_bothStrand_3UTRnormalised.bw"
