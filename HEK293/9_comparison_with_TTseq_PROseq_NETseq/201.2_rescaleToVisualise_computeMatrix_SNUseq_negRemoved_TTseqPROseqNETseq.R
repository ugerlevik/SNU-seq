...
## Script purpose: Rescale deepTools computeMatrix output 
##                 (TSS–TES matrices of SNU-seq, PRO-seq, TT-seq, mNET-seq)
##                 to adjust specific samples (e.g. PRO-seq, TT-seq) 
...
scale_factors["\"GSM6738185_mNETseq\""] <- 0.06
scale_factors["\"GSM4964193_NETseq\""] <- 1.5
