...
## Script purpose: Apply DESeq2 scaling factors to BedGraph files - TTseq
## Date: Apr 4, 2025
...
# Directory paths
input_bedgraph_folder=$prefix/4_TTseq_Phil/1.2_bedgraphs

output_bedgraph_folder=$prefix/4_TTseq_Phil/1.4_genebodyNormalised_bedgraph
output_bigwig_folder=$prefix/4_TTseq_Phil/1.5_genebodyNormalised_bigwig
output_bedgraph_bothStrand_folder=$prefix/4_TTseq_Phil/1.6_genebodyNormalised_bedgraph_bothStrand
output_bigwig_bothStrand_folder=$prefix/4_TTseq_Phil/1.7_genebodyNormalised_bigwig_bothStrand
...
scaling_factors_file=$prefix/4_TTseq_Phil/1.3_countsRegions_fromBedgraph/DESeq2_scalingFactors_3UTRs.txt
...
for bedgraph_file_fwd in "$output_bedgraph_folder"/*_fwd_genebodyNormalised.bedgraph; do
    ...
    # Step 2.3: Convert to BigWig for bothStrand 4_TTseq_Phil
