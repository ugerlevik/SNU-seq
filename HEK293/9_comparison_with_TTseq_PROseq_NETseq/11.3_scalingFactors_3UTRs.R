...
## Script purpose: Calculate Scaling factors for 3'UTR normalisation (bPAP vs TTseq)
## Date: Apr 4, 2025
...
# Set file paths
prefix <- "/MellorLab/SNUseqProject/4_TTseq_Phil/1.3_countsRegions_fromBedgraph"
