...
# Directory paths
input_bigwig_folder=$prefix/4_TTseq_Phil/1.4_genebodyNormalised_bedgraph
output_bedgraph_folder=$prefix/4_TTseq_Phil/1.4_genebodyNormalised_bedgraph/reverseNegative
