...
# Directory paths
input_bigwig_folder=$prefix/4_TTseq_Phil/1.1_bigwigs
output_bedgraph_folder=$prefix/4_TTseq_Phil/1.2_bedgraphs
negative_bedgraph_folder=$prefix/4_TTseq_Phil/1.2_bedgraphs/reverseNegative
