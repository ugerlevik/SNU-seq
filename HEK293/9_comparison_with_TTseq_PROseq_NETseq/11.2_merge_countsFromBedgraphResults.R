...
## Script purpose: TTseq - Merge counts from 3' UTR regions (no need normalization by region length)
## Date: Apr 4, 2025
...
merged_dir <- "/MellorLab/SNUseqProject/4_TTseq_Phil/1.3_countsRegions_fromBedgraph/individualResults"
output_dir <- "/MellorLab/SNUseqProject/4_TTseq_Phil/1.3_countsRegions_fromBedgraph"
