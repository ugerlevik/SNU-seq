...
## Script purpose: Count 3' UTRs (stranded) with TT-seq
## Date: Apr 4, 2025
...
inputDir="$prefix/4_TTseq_Phil/1.2_bedgraphs"

annotationDir="$common_prefix/annotations"
sortedAnnoDir="$annotationDir/sorted"

strandedOutputDir="$prefix/4_TTseq_Phil/1.3_countsRegions_fromBedgraph/individualResults/strandsSeparated"
mergedOutputDir="$prefix/4_TTseq_Phil/1.3_countsRegions_fromBedgraph/individualResults"
